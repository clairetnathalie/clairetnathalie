...
<body>
<div style="text-align: center; padding: 20px;"><img
	src="<?php echo $subfolder;?>assets/img/login-logo.png" alt="GoCart" /></div>
<div class="container">
<div class="row">
...
eliminate "index.php" from the URL by generating an .htaccess file.</p>
</div>
		<?php endif;?>
		<?php if($errors):?>
			<div class="alert alert-error">
...
<h4>Note&hellip;</h4>
<p>Installing GoCart will not create a database. It will simply fill
your existing database with the appropriate tables and records required
to run.</p>
</div>
...
<fieldset><legend>Admin Information</legend> <label for="login">Admin
Email</label> <?php echo form_input(array('class'=>'span8', 'name'=>'admin_email', 'value'=>set_value('admin_email') ));?>
...
<fieldset><legend>Cart Information</legend> <label for="company_name">Company
Name</label> <?php echo form_input(array('class'=>'span8', 'name'=>'company_name', 'value'=>set_value('company_name') ));?>
				...
				<label class="checkbox">
					...
					<?php echo form_checkbox('mod_rewrite', '1', (bool)set_value('mod_rewrite') );?> Remove "index.php" from the url <small>(requires
Apache with mod_rewrite)</small> </label></fieldset>
...
<hr>
<div class="footer">
<div style="text-align: center;"><a href="http://gocartdv.com"
	target="_blank"><img
	src="<?php echo $subfolder;?>assets/img/driven-by-gocart.png"
	alt="Driven By GoCart"></a></div>
</div>
