...
function create_sortable()
{
	...
	$('#products_sortable').sortable('enable');
}

function save_sortable()
{
	serial=$('#products_sortable').sortable('serialize');
	alert("Sort is not implemented fully, Sorry!");

	/*
    $.ajax({
		url:'<?php echo site_url($this->config->item('admin_folder').'/products/organize');?>',
		type:'POST',
		data:serial
	});
	*/
...
<div class="btn-group pull-right">
			...
			<a class="btn"
	href="<?php echo site_url($this->config->item('admin_folder').'/products/english_version/products'); ?>"><i
	class="icon-globe"></i> <?php echo lang('english_version');?></a>
			<?php elseif($this->session->userdata('db_active_group') == 'english'):?>
			<a class="btn"
	href="<?php echo site_url($this->config->item('admin_folder').'/products/french_version/products'); ?>"><i
