...
<div class="alert alert-info" style="text-align: center;"><strong><?php echo sprintf(lang('times_used'), @$num_uses);?></strong>
</div>
<div class="row">
<div class="span4">
<fieldset><label for="code"><?php echo lang('coupon_code');?></label>
			<?php
	...
	id="datepicker1_alt" /> <label for="end_date"><?php echo lang('disable_on');?></label>
			<?php
	...
	id="datepicker2_alt" /> <label for="reduction_target"><?php echo lang('coupon_type');?></label>
			<?php
			$options = array ('price' => lang ( 'price_discount' ), 'shipping' => lang ( 'free_shipping' ) );
...
$options = array ('percent' => '%', 'fixed' => $this->config->item ( 'currency_symbol' ) );
...
<div class="span6 offset1 well">
		<?php
		$options = array ('1' => lang ( 'apply_to_whole_order' ), '0' => lang ( 'apply_to_select_items' ) );
...
<table width="100%" border="0" style="margin-top: 10px;" cellspacing="5"
	cellpadding="0">
