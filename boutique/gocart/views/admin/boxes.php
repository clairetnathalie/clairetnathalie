...
<a class="btn"
	href="<?php echo site_url($this->config->item('admin_folder').'/boxes/english_version/boxes'); ?>"><i
	class="icon-globe"></i> <?php echo lang('english_version');?></a>
<?php elseif($this->session->userdata('db_active_group') == 'english'):?>
<a class="btn"
	href="<?php echo site_url($this->config->item('admin_folder').'/boxes/french_version/boxes'); ?>"><i
...
<table class="table table-striped">
	...
	<?php
		...
		<tr id="boxes-<?php echo $box->id;?>">
			...
			<td><span style="margin-left: 10px;" class="<?php echo $visible;?>"></span></td>
			<td>
