...
$show = array ('name' => 'show', 'value' => 1, 'checked' => set_checkbox ( 'show', 1, $show ) );
?>
...
<label class="checkbox">
	    <?php echo form_checkbox($show); ?> <?php echo lang('visibility');?>
	</label>
...
<?php echo form_upload($f_image); ?>
	...
	<?php if($id && $image != ''):?>
<div style="text-align: center; padding: 5px; border: 1px solid #ccc;"><img
