...
<div class="span6">
<form class="form-inline pull-right"><input class="span2" type="text"
	id="best_sellers_start" placeholder="<?php echo lang('from');?>" /> <input
	type="hidden" name="best_sellers_start" id="best_sellers_start_alt" />
<input class="span2" type="text" id="best_sellers_end"
...
<div id="saving_text"
	style="text-align: center; width: 100%; position: fixed; left: 0px; top: 50%; margin-top: 40px; color: #fff; z-index: 100001"><?php echo lang('loading');?></div>
</div>
