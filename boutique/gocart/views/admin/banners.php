...
<a class="btn"
	href="<?php echo site_url($this->config->item('admin_folder').'/banners/english_version/banners'); ?>"><i
	class="icon-globe"></i> <?php echo lang('english_version');?></a>
<?php elseif($this->session->userdata('db_active_group') == 'english'):?>
<a class="btn"
	href="<?php echo site_url($this->config->item('admin_folder').'/banners/french_version/banners'); ?>"><i
