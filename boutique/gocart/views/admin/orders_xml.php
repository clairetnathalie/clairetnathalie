...
<shipping_notes><?php echo htmlspecialchars(preg_replace('!\s+!m', ' ', strip_tags($order->shipping_notes)));?></shipping_notes>
<shipping_method><?php echo htmlspecialchars(preg_replace('!\s+!m', ' ', strip_tags($order->shipping_method)));?></shipping_method>
<?php 	if(isset($order->heard_about)):?>
...
<?php	 		if($k=='options'): ?>
				<<?php echo $k; ?>><?php foreach($v as $key=>$value):?>
<option><name><?php echo $key; ?></name> <answer><?php echo $value; ?></answer>
</option>
<?php endforeach; ?></<?php 	echo $k; ?>>
<?php 			else:?>
<?php 				if($k=='description'):?>
				<<?php echo $k; ?>><?php echo htmlspecialchars(preg_replace('!\s+!m', ' ', strip_tags(preg_replace('/\<\/p\>/', ' ', preg_replace('/\<br(\s)*(\/)*\>/', ' ', preg_replace('/&nbsp;/', ' ', $v)))))); ?></<?php echo $k; ?>>
<?php 				elseif($k=='file_list'):?>
				<<?php echo $k; ?>><?php echo json_encode($v); ?></<?php echo $k; ?>>
<?php 				elseif($k=='post_options'):?>
				<<?php echo $k; ?>><?php echo json_encode($v); ?></<?php echo $k; ?>>
<?php 				else:?>
				<<?php echo $k; ?>><?php echo $v; ?></<?php echo $k; ?>>
<?php 				endif;?>
<?php 			endif;?>
<?php 		endforeach;?>
</item>
