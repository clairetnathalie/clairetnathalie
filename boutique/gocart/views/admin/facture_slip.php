...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
	...
	<div><img
	src="<?php echo base_url((!preg_match('/localhost/', current_url())?'':'clairetathalie/').CONTENT_FOLDER.$this->config->item('site_logo'));?>" />
</div>
	<?php endif; ?>
	...
	<tr>
		...
		<td style="width: 40%; vertical-align: top;"><strong><?php echo lang('bill_to_address');?></strong><br />
		...
		<td style="width: 40%; vertical-align: top;" class="packing"><strong><?php echo lang('ship_to_address');?></strong><br />		
	...
	<tr>
		...
		<td style="border-top: 1px solid #000;"><strong><?php echo lang('payment_method');?></strong>
				<?php echo $order->payment_info; ?>
			</td>
		<td style="border-top: 1px solid #000;"><strong><?php echo lang('shipping_details');?></strong>
		...
		<tr>
		<td colspan="3" style="border-top: 1px solid #000;"><strong><?php echo lang('gift_note');?></strong>
		...
		<?php if(!empty($order->shipping_notes)):?>
			<tr>
		<td colspan="3" style="border-top: 1px solid #000;"><strong><?php echo lang('shipping_notes');?></strong><br /><?php echo $order->shipping_notes;?>
				</td>
	</tr>
		<?php endif;?>
	</table>
