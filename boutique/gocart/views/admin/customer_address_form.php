...
<div class="row">
<div class="span2"><label><?php echo lang('city');?></label>
			<?php echo form_input($f_city);?>
		</div>
<div class="span3"><label><?php echo lang('state');?></label>
			<?php echo form_dropdown('zone_id', $zones_menu, set_value('zone_id', $zone_id), 'id="f_zone_id" class="span3"');?>
		</div>
<div class="span1"><label><?php echo lang('postcode');?></label>
