...
<div class="alert"><a class="close" data-dismiss="alert">×</a> <strong><?php echo lang('common_note') ?>:</strong> <?php echo lang('no_payment_module_installed'); ?>
	</div>

<?php endif;?>

<?php if(!$shipping_module_installed):?>
<div class="alert"><a class="close" data-dismiss="alert">×</a> <strong><?php echo lang('common_note') ?>:</strong> <?php echo lang('no_shipping_module_installed'); ?>
	</div>
...
<table class="table table-striped">
	...
	<tbody>
    <?php $status_french_array = (array)$this->config->item('order_statuses');?>
    <?php foreach($orders as $order): ?>
	<tr>
			<td class="gc_cell_left"><a
				href="<?php echo site_url($this->config->item('admin_folder').'/orders/view/'.$order->id); ?>"><?php echo $order->order_number; ?></a></td>
			...
			<?php echo $status_french_array[$order->status]; ?>
		</td>
			<td class="gc_cell_right">
			<div class="MainTableNotes"><?php echo $order->notes; ?></div>
			</td>
		</tr>
    <?php endforeach; ?>
    </tbody>
...
<div class="row">
<div class="span12" style="text-align: center;"><a class="btn btn-large"
	href="<?php echo $admin_url;?>orders"><?php echo lang('view_all_orders');?></a>
</div>
</div>
...
<div class="row">
<div class="span12" style="text-align: center;"><a class="btn btn-large"
	href="<?php echo $admin_url;?>customers"><?php echo lang('view_all_customers');?></a>
</div>
</div>
