...
//connected product
$lang ['connected_product'] = '<strong class="text-info">Produit connected to another product as an option</strong><br><small>&#9658; For exemple <strong>Housse "Volcanique"</strong> is an option of the product <strong>Kit "Couettabra" 2 Places</strong></small>';
$lang ['connected'] = 'Product connected to another product';
$lang ['not_connected'] = 'Product not-connected to another product';
$lang ['link_to_product_id'] = 'Id number of connected product';
$lang ['select_a_connected_product'] = 'Define which parent product to connect to';
$lang ['not_null_connected_product'] = 'that defines the parent product to connect to,';
$lang ['error_no_connected_product'] = 'You have decided to connect this product to another. Please define the parent product to connect to';
$lang ['search_by_name_of_product'] = 'Search by product name';
$lang ['add_connected_product'] = 'Connect to this product';
...
$lang ['confirm_remove_connected'] = 'Are you sure you want to remove this connected product?';
...
$lang ['alert_product_connected'] = 'This product is already connected.';
$lang ['alert_select_product_connected'] = 'Please select a product to add first.';
...
$lang ['sort'] = 'Sort';
$lang ['sort_products'] = 'Products are sortable! Just drag and drop them in the order you would like for them to appear.';