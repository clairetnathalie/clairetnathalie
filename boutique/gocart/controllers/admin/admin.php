...
class Admin extends Admin_Controller {
	...
	function index() {
		$this->data ['page_title'] = lang ( 'admins' );
	...
	function form($id = false) {
		...
		$this->data ['page_title'] = lang ( 'admin_form' );
		...
		if ($id) {
			...
			$this->data ['firstname'] = $admin->firstname;
			$this->data ['lastname'] = $admin->lastname;
			$this->data ['email'] = $admin->email;
			$this->data ['access'] = $admin->access;
		}
		...
		if ($this->form_validation->run () == FALSE) {
			$this->load->view ( $this->config->item ( 'admin_folder' ) . '/admin_form', $this->data );
		} else {
			$save ['id'] = $id;
