...
class Customers extends Admin_Controller {
	...
	function index($field = 'lastname', $by = 'ASC', $page = 0) {
		...
		$this->data ['customers'] = $this->Customer_model->get_customers ( 50, $page, $field, $by );
		...
		$this->load->view ( $this->config->item ( 'admin_folder' ) . '/customers', $this->data );
	}
	...
	function form($id = false) {
		...
		$this->form_validation->set_rules ( 'phone', 'lang:phone', 'trim|max_length[32]' );
