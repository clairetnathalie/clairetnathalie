...
$autoload['libraries'] = array('database', 'session', 'auth', 'go_cart', 'user_agent');
...
$autoload['language'] = array(); /* Because dynamically set config item 'languauge' on the fly in MY_Controller */
