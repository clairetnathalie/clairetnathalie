...
class usps_domestic {
	...
	function usps_domestic() {
		...
		$this->service_list = array (// Domestic Services
		"Express Mail&lt;sup&gt;&amp;reg;&lt;/sup&gt;", "Express Mail&lt;sup&gt;&amp;reg;&lt;/sup&gt; Hold For Pickup", "Express Mail&lt;sup&gt;&amp;reg;&lt;/sup&gt; Sunday\/Holiday Delivery", "Express Mail&lt;sup&gt;&amp;reg;&lt;/sup&gt; Flat Rate Envelope", "Express Mail&lt;sup&gt;&amp;reg;&lt;/sup&gt; Flat Rate Envelope Hold For Pickup", "Express Mail&lt;sup&gt;&amp;reg;&lt;/sup&gt; Sunday\/Holiday Delivery Flat Rate Envelope", "Express Mail&lt;sup&gt;&amp;reg;&lt;/sup&gt; Legal Flat Rate Envelope", "Express Mail&lt;sup&gt;&amp;reg;&lt;/sup&gt; Legal Flat Rate Envelope Hold For Pickup", "Express Mail&lt;sup&gt;&amp;reg;&lt;/sup&gt; Sunday\/Holiday Delivery Legal Flat Rate Envelope", "Priority Mail&lt;sup&gt;&amp;reg;&lt;/sup&gt;", "Priority Mail&lt;sup&gt;&amp;reg;&lt;/sup&gt; Large Flat Rate Box", "Priority Mail&lt;sup&gt;&amp;reg;&lt;/sup&gt; Medium Flat Rate Box", "Priority Mail&lt;sup&gt;&amp;reg;&lt;/sup&gt; Small Flat Rate Box", "Priority Mail&lt;sup&gt;&amp;reg;&lt;/sup&gt; Flat Rate Envelope", "Priority Mail&lt;sup&gt;&amp;reg;&lt;/sup&gt; Legal Flat Rate Envelope", "Priority Mail&lt;sup&gt;&amp;reg;&lt;/sup&gt; Padded Flat Rate Envelope", "Priority Mail&lt;sup&gt;&amp;reg;&lt;/sup&gt; Gift Card Flat Rate Envelope", "Priority Mail&lt;sup&gt;&amp;reg;&lt;/sup&gt; Small Flat Rate Envelope", "Priority Mail&lt;sup&gt;&amp;reg;&lt;/sup&gt; Window Flat Rate Envelope", "Parcel Post&lt;sup&gt;&amp;reg;&lt;/sup&gt;", "Media Mail&lt;sup&gt;&amp;reg;&lt;/sup&gt;", "Library Mail" );
					...
					if (is_numeric ( $handling_amount )) // valid entry?
{
	...
	function install() {
		$default_settings = array ('mode' => 'test', 'username' => '', 'password' => '', 'container' => 'Flat Rate Box', 'service' => implode ( ',', array_keys ( $this->service_list ) ), 'size' => 'LARGE', 'length' => '', 'width' => '', 'height' => '', 'girth' => '', 'machinable' => 'true', 'handling_method' => '$', 'handling_amount' => 5, 'enabled' => '0' );
	...
	function form($post = false) {
		...
		?>
<div class="row">
<div class="span12"><label><?php echo lang('username');?></label>
...
<label><?php echo lang('container')?></label>
				<?php
		$opts = array ('VARIABLE' => lang ( 'variable' ), 'FLAT RATE BOX' => lang ( 'flat_rate_box' ), 'MD FLAT RATE BOX' => lang ( 'medium_flat_rate_box' ), 'LG FLAT RATE BOX' => lang ( 'large_flat_rate_box' ), 'FLAT RATE ENVELOPE' => lang ( 'flat_rate_envelope' ), 'RECTANGULAR' => lang ( 'rectangular' ), 'NONRECTANGULAR' => lang ( 'non_rectangular' ) );
		...
		?>
				...
				<?php
		$opts = array ('REGULAR' => lang ( 'regular' ), 'LARGE' => lang ( 'large' ), 'OVERSIZE' => lang ( 'oversize' ) );
...
<label><?php echo lang('package_length');?></label>
				...
				<label><?php echo lang('handling_fee');?></label></div>
</div>
<div class="row">
<div class="span1">
...
<div class="row">
<div class="span12"><label><?php echo lang('enabled');?></label>
