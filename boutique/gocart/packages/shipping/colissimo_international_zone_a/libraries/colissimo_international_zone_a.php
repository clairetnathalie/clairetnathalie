...
class colissimo_international_zone_a {
	var $CI;
	var $cart;
	
	function colissimo_international_zone_a() {
		$this->CI = & get_instance ();
		$this->CI->lang->load ( 'colissimo_international_zone_a' );
	}
	...
	function rates() {
		...
		$settings = $this->CI->Settings_model->get_settings ( 'colissimo_international_zone_a' );
	...
	function install() {
		...
		$rate [0] ['rates'] = array ('0.000' => '15.34', '1.000' => '16.96', '2.000' => '20.47', '3.000' => '23.99', '4.000' => '27.50', '5' => '31.02', '6' => '34.53', '7' => '38.05', '8' => '41.56', '9' => '45.08', '10' => '51.92', '15' => '58.76' );
		
		$install ['rates'] = serialize ( $rate );
		
		$this->CI->Settings_model->save_settings ( 'colissimo_international_zone_a', $install );
	}
	
	function uninstall() {
		$this->CI->Settings_model->delete_settings ( 'colissimo_international_zone_a' );
	}
	...
	function form() {
		...
		return $this->CI->load->view ( 'colissimo_international_zone_a_form', $data, true );
	...
	function check() {
		...
		$this->CI->Settings_model->save_settings ( 'colissimo_international_zone_a', $save );
