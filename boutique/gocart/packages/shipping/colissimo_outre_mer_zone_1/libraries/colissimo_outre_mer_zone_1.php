...
class colissimo_outre_mer_zone_1 {
	var $CI;
	var $cart;
	
	function colissimo_outre_mer_zone_1() {
		$this->CI = & get_instance ();
		$this->CI->lang->load ( 'colissimo_outre_mer_zone_1' );
	}
	...
	function rates() {
		...
		$settings = $this->CI->Settings_model->get_settings ( 'colissimo_outre_mer_zone_1' );
	...
	function install() {
		...
		$rate [0] ['rates'] = array ('0.000' => '8.27', '0.500' => '12.49', '1.000' => '17.05', '2.000' => '21.61', '3.000' => '26.17', '4.000' => '30.73', '5' => '35.29', '6' => '39.85', '7' => '44.41', '8' => '48.97', '9' => '53.53', '10' => '76.33', '15' => '99.13' );
		
		$install ['rates'] = serialize ( $rate );
		
		$this->CI->Settings_model->save_settings ( 'colissimo_outre_mer_zone_1', $install );
	}
	
	function uninstall() {
		$this->CI->Settings_model->delete_settings ( 'colissimo_outre_mer_zone_1' );
	}
	...
	function form() {
		...
		return $this->CI->load->view ( 'colissimo_outre_mer_zone_1_form', $data, true );
	...
	function check() {
		...
		$this->CI->Settings_model->save_settings ( 'colissimo_outre_mer_zone_1', $save );
