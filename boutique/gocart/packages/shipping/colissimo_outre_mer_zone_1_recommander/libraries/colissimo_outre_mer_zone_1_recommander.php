...
class colissimo_outre_mer_zone_1_recommander {
	var $CI;
	var $cart;
	
	function colissimo_outre_mer_zone_1_recommander() {
		$this->CI = & get_instance ();
		$this->CI->lang->load ( 'colissimo_outre_mer_zone_1_recommander' );
	}
	...
	function rates() {
		...
		$settings = $this->CI->Settings_model->get_settings ( 'colissimo_outre_mer_zone_1_recommander' );
	...
	function install() {
		...
		$rate [0] ['rates'] = array ('0.000' => '11.50', '0.500' => '15.72', '1.000' => '20.28', '2.000' => '24.84', '3.000' => '29.40', '4.000' => '33.96', '5' => '38.52', '6' => '43.08', '7' => '47.64', '8' => '52.20', '9' => '56.76', '10' => '79.56', '15' => '102.36' );
		
		$install ['rates'] = serialize ( $rate );
		
		$this->CI->Settings_model->save_settings ( 'colissimo_outre_mer_zone_1_recommander', $install );
	}
	
	function uninstall() {
		$this->CI->Settings_model->delete_settings ( 'colissimo_outre_mer_zone_1_recommander' );
	}
	...
	function form() {
		...
		return $this->CI->load->view ( 'colissimo_outre_mer_zone_1_recommander_form', $data, true );
	...
	function check() {
		...
		$this->CI->Settings_model->save_settings ( 'colissimo_outre_mer_zone_1_recommander', $save );
