...
class colissimo_international_zone_b {
	var $CI;
	var $cart;
	
	function colissimo_international_zone_b() {
		$this->CI = & get_instance ();
		$this->CI->lang->load ( 'colissimo_international_zone_b' );
	}
	...
	function rates() {
		...
		$settings = $this->CI->Settings_model->get_settings ( 'colissimo_international_zone_b' );
	...
	function install() {
		...
		$rate [0] ['rates'] = array ('0.000' => '18.81', '1.000' => '20.62', '2.000' => '24.94', '3.000' => '29.26', '4.000' => '33.58', '5' => '37.91', '6' => '42.23', '7' => '46.55', '8' => '50.87', '9' => '55.20', '10' => '65.08', '15' => '74.96' );
		
		$install ['rates'] = serialize ( $rate );
		
		$this->CI->Settings_model->save_settings ( 'colissimo_international_zone_b', $install );
	}
	
	function uninstall() {
		$this->CI->Settings_model->delete_settings ( 'colissimo_international_zone_b' );
	}
	...
	function form() {
		...
		return $this->CI->load->view ( 'colissimo_international_zone_b_form', $data, true );
	...
	function check() {
		...
		$this->CI->Settings_model->save_settings ( 'colissimo_international_zone_b', $save );
