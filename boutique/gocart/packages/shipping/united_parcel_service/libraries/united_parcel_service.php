					...
					if (is_numeric ( $handling_amount )) // valid entry?
{
	...
	function install() {
		$default_settings = array ('access_key' => '', 'ups_account_username' => '', 'ups_account_password' => '', 'services' => '11', 'handling_method' => '$', 'handling_amount' => '5', 'enabled' => '0' );
...
<label class="checkbox"> <input type="checkbox" name="services[]"
	value="<?php echo $id;?>"
	<?php echo (in_array($id, $services))?'checked="checked"':'';?> />
				<?php echo $opt;?>
			</label>
<?php endforeach;?>
