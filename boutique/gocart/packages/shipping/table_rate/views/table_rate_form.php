<div class="row">
<div class="span12"><select name="enabled" class="span3">
	<option value="1"
...
<ul id="table_details_var_count" class="row table_details"
	...
	<div class="form-inline pull-right" style="margin: 10px 0px;"><input
		type="input" class="span1" placeholder="<?php echo lang('from');?>"
		id="from_field_var_count" /> <input type="input" class="span1"
