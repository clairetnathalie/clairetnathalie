...
class tablerate {
	...
	function install() {
		...
		$rates = array ('80' => '85.00', '70' => '65.00', '60' => '55.00', '50' => '55.00', '40' => '45.00', '30' => '35.00', '20' => '25.00', '10' => '15.00', '0' => '5.00' );
		...
		$this->CI->Settings_model->save_settings ( 'tablerate', array ('enabled' => '0', 'method' => serialize ( array ('Example' => 'price' ) ), 'location' => serialize ( array ('Example' => '' ) ) )//location is by country ID
 );
	}
	...
	function form($post = false) {
		...
		// fetch form contents
		$data = array ('settings' => $settings, 'rates' => $rates, 'countries' => $countries );
