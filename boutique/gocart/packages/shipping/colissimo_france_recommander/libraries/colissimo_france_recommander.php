...
class colissimo_france_recommander {
	var $CI;
	var $cart;
	
	function colissimo_france_recommander() {
		$this->CI = & get_instance ();
		$this->CI->lang->load ( 'colissimo_france_recommander' );
	}
	...
	function rates() {
		...
		$settings = $this->CI->Settings_model->get_settings ( 'colissimo_france_recommander' );
	...
	function install() {
		...
		$rate [0] ['rates'] = array ('0.000' => '8.46', '0.250' => '9.03', '0.500' => '9.79', '0.750' => '10.36', '1.000' => '11.31', '2.000' => '12.45', '3.000' => '14.54', '5' => '16.63', '7' => '19.76', '10' => '22.37', '15' => '30.16' );
		
		$install ['rates'] = serialize ( $rate );
		
		$this->CI->Settings_model->save_settings ( 'colissimo_france_recommander', $install );
	}
	
	function uninstall() {
		$this->CI->Settings_model->delete_settings ( 'colissimo_france_recommander' );
	}
	...
	function form() {
		...
		return $this->CI->load->view ( 'colissimo_france_recommander_form', $data, true );
	...
	function check() {
		...
		$this->CI->Settings_model->save_settings ( 'colissimo_france_recommander', $save );
