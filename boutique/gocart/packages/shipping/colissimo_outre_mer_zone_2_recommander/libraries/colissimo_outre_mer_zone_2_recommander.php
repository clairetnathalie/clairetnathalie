...
class colissimo_outre_mer_zone_2_recommander {
	var $CI;
	var $cart;
	
	function colissimo_outre_mer_zone_2_recommander() {
		$this->CI = & get_instance ();
		$this->CI->lang->load ( 'colissimo_outre_mer_zone_2_recommander' );
	}
	...
	function rates() {
		...
		$settings = $this->CI->Settings_model->get_settings ( 'colissimo_outre_mer_zone_2_recommander' );
	...
	function install() {
		...
		$rate [0] ['rates'] = array ('0.000' => '13.11', '0.500' => '18.15', '1.000' => '29.55', '2.000' => '40.95', '3.000' => '52.35', '4.000' => '63.75', '5' => '75.15', '6' => '86.55', '7' => '97.95', '8' => '109.35', '9' => '120.75', '10' => '177.75', '15' => '234.75' );
		
		$install ['rates'] = serialize ( $rate );
		
		$this->CI->Settings_model->save_settings ( 'colissimo_outre_mer_zone_2_recommander', $install );
	}
	
	function uninstall() {
		$this->CI->Settings_model->delete_settings ( 'colissimo_outre_mer_zone_2_recommander' );
	}
	...
	function form() {
		...
		return $this->CI->load->view ( 'colissimo_outre_mer_zone_2_recommander_form', $data, true );
	...
	function check() {
		...
		$this->CI->Settings_model->save_settings ( 'colissimo_outre_mer_zone_2_recommander', $save );
