...
class usps_international {
	...
	function usps_international() {
		...
		"USPS GXG&lt;sup&gt;&amp;trade;&lt;/sup&gt; Envelopes**", "Express Mail&lt;sup&gt;&amp;reg;&lt;/sup&gt; International", "Express Mail&lt;sup&gt;&amp;reg;&lt;/sup&gt; International Flat Rate Envelope", "Express Mail&lt;sup&gt;&amp;reg;&lt;/sup&gt; International Legal Flat Rate Envelope", "Priority Mail&lt;sup&gt;&amp;reg;&lt;/sup&gt; International", "Priority Mail&lt;sup&gt;&amp;reg;&lt;/sup&gt; International Large Flat Rate Box", "Priority Mail&lt;sup&gt;&amp;reg;&lt;/sup&gt; International Medium Flat Rate Box", "Priority Mail&lt;sup&gt;&amp;reg;&lt;/sup&gt; International Small Flat Rate Box**", "Priority Mail&lt;sup&gt;&amp;reg;&lt;/sup&gt; International DVD Flat Rate Box**", "Priority Mail&lt;sup&gt;&amp;reg;&lt;/sup&gt; International Large Video Flat Rate Box**", "Priority Mail&lt;sup&gt;&amp;reg;&lt;/sup&gt; International Flat Rate Envelope**", "Priority Mail&lt;sup&gt;&amp;reg;&lt;/sup&gt; International Legal Flat Rate Envelope**", "Priority Mail&lt;sup&gt;&amp;reg;&lt;/sup&gt; International Padded Flat Rate Envelope**", "Priority Mail&lt;sup&gt;&amp;reg;&lt;/sup&gt; International Gift Card Flat Rate Envelope**", "Priority Mail&lt;sup&gt;&amp;reg;&lt;/sup&gt; International Small Flat Rate Envelope**", "Priority Mail&lt;sup&gt;&amp;reg;&lt;/sup&gt; International Window Flat Rate Envelope**", "First-Class Mail&lt;sup&gt;&amp;reg;&lt;/sup&gt; International Package**", "First-Class Mail&lt;sup&gt;&amp;reg;&lt;/sup&gt; International Large Envelope**" )
				...
				if (is_numeric ( $handling_amount )) // valid entry?
{
	...
	function install() {
		$default_settings = array ('username' => '', 'password' => '', 'mailtype' => 'ALL', 'container' => 'RECTANGULAR', 'service' => implode ( ',', array_keys ( $this->service_list ) ), 'size' => 'LARGE', 'length' => '', 'width' => '', 'height' => '', 'girth' => '', 'machinable' => 'true', 'handling_method' => '$', 'handling_amount' => 5, 'enabled' => '0' );
...
<?php
		$opts = array ('ALL' => lang ( 'all' ), 'PACKAGE' => lang ( 'package' ), 'ENVELOPE' => lang ( 'envelope' ) );
...
<?php
		$opts = array ('RECTANGULAR' => lang ( 'rectangular' ), 'NONRECTANGULAR' => lang ( 'non_rectangular' ) );
