...
<div class="span4"><label><?php echo lang('api_url');?> <strong>*</strong></label>
					<?php echo form_input('api_url', $Api_Url, 'class="span3"');?>
			
					<label><?php echo lang('api_login');?> <strong>*</strong></label>
					<?php echo form_input('api_login', $Api_Login, 'class="span3"');?>
			
					<label><?php echo lang('api_password');?> <strong>*</strong></label>
					<?php echo form_input('api_password', $Api_Password, 'class="span3"');?>
