...
<input name="x_first_name" type="text"
	class="pmt_required textfield input"
	value="<?php echo @$cc_data["x_first_name"] ?>" size="30" /></div>
<div>
			<?php echo lang('address_lastname') ?><b class="r"> *</b><br />
<input name="x_last_name" type="text"
	class="pmt_required textfield input"
	value="<?php echo @$cc_data["x_last_name"] ?>" size="30" /></div>
</div>
<div class="form_wrap">
<div>
			<?php echo lang('card_number') ?><b class="r"> *</b><br />
<input id="card_num" name="x_card_num" type="text"
	class="pmt_required textfield input"
	value="<?php echo @$cc_data["x_card_num"] ?>" size="30"></div>
<div>
...
<input style="width: 30px;" name="x_card_code" type="text"
	class="pmt_required textfield input" id="x_card_code" maxlength="4"
	value="<?php echo @$cc_data["x_card_code"] ?>" /></div>
</div>
<br style="clear: both;">