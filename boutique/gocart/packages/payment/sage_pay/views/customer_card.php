...
echo form_dropdown ( 'StartDate_mm', $months, @$sp_data ["StartDate_mm"], 'class="input"' ) . '/' . form_dropdown ( 'StartDate_yy', $valid_from_years, @$sp_data ["StartDate_yy"], 'class="input"' );
												?>
        </div>
<div>
...
echo form_dropdown ( 'ExpiryDate_mm', $months, @$sp_data ["ExpiryDate_mm"], 'class="input"' ) . '/' . form_dropdown ( 'ExpiryDate_yy', $expires_on_years, @$sp_data ["ExpiryDate_yy"], 'class="input"' );
			?>
		</div>
<div>
