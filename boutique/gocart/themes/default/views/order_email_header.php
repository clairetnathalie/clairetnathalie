...
<title><?php echo lang('your_order')?> {site_name}</title>
<style type="text/css">
	...
	<tr>
		...
		<table border="0" width="600" cellpadding="0" cellspacing="0"
			...
			<tr>
				...
				<table border="0" cellpadding="0" cellspacing="0"
                	...
                	<!-- <img src="<?php echo base_url((!preg_match('/localhost/', current_url())?'':'clairetnathalie/').CONTENT_FOLDER.'default/assets/img/icons/cn_corner-carousel-top-left.png');?>" style="width: 15px;height:15px;" /> -->
						...
						<img
							...
							style="width: 15px; height: 15px; vertical-align: top;" /></td>
						<td
				...
				<div
					style="font-weight: bold; font-size: 18px; line-height: 24px; color: #6ab5cb;">
