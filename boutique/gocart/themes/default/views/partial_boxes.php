...
<div class="span3">
	...
	href="<?php echo $box->link ;?>" <?php echo $target ;?>>
					...
					<?php
					$box_bg_1 = "background-image: url('" . base_url ( (! preg_match ( '/localhost/', current_url () ) ? '' : 'clairetnathalie/') . IMG_UPLOAD_FOLDER . 'images/full/' . $box->image ) . "');";
					$box_bg_2 = "background-image: url('" . base_url ( (! preg_match ( '/localhost/', current_url () ) ? '' : 'clairetnathalie/') . CONTENT_FOLDER . 'default/assets/img/logo/h2_bg.png' ) . "'), url('" . base_url ( (! preg_match ( '/localhost/', current_url () ) ? '' : 'clairetnathalie/') . IMG_UPLOAD_FOLDER . 'images/full/' . $box->image ) . "');";
					...
					<div style="<?php echo $box_bg_1;?>" class="cn-box-std">
...
<div class="cn-box-logo-couettabra">&nbsp;</div>
					...
					<div class="cn-box-title-logo" style="padding-top: 0;">
<div class="cn-box-title-color-std partial-box" itemprop="alternateName">
...
<div class="fb-like-box"
	...
	data-height="580" data-colorscheme="light" data-show-faces="true"
