...
<table>
	<tr>
		...
		<?php foreach ($payment_methods as $method=>$info):?>
			...
			?>
			<p><input type="radio" name="payment_method" <?php echo $selected;?>
			value="<?php echo $method;?>" onchange="set_payment(this.value)"> <?php echo $info['name'];?></p>
		<?php endforeach;?>
		</td>
	</tr>
</table>
...
<h3><?php echo $info['name']; ?></h3>
	...
	value="<?php echo lang('submit_payment_method');?>" /></div>
<?php echo form_close(); ?>
	<?php endforeach;?>
