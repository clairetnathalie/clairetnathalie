...
<div class="row">
	...
	href="<?php echo $box->link ;?>" <?php echo $target ;?>>
			...
			<?php
		$box_bg_1 = "background: url('" . base_url ( (! preg_match ( '/localhost/', current_url () ) ? '' : 'clairetnathalie/') . IMG_UPLOAD_FOLDER . 'images/full/' . $box->image ) . "'); background-repeat: no-repeat; background-position: center center; -webkit-background-size: auto 120%; -moz-background-size: auto 120%; -o-background-size: auto 120%; background-size: auto 120%;";
		$box_bg_2 = "background: url('" . base_url ( (! preg_match ( '/localhost/', current_url () ) ? '' : 'clairetnathalie/') . CONTENT_FOLDER . 'default/assets/img/logo/h2_bg.png' ) . "'), url('" . base_url ( (! preg_match ( '/localhost/', current_url () ) ? '' : 'clairetnathalie/') . IMG_UPLOAD_FOLDER . 'images/full/' . $box->image ) . "'); background-repeat: no-repeat; background-position: center center; -webkit-background-size: auto 120%; -moz-background-size: auto 120%; -o-background-size: auto 120%; background-size: auto 120%;";
		...
		?>
			...
			<div class="cn-box-std" style="<?php echo $box_bg_1;?>">
...
<div class="cn-box-logo-couettabra">&nbsp;</div>
			...
			<div class="cn-box-title-logo" style="padding-top: 8px;">
<div class="cn-box-title-color-std" itemprop="alternateName"
	style="background: #6ab5cc; width: 100%; height: 60%; padding-bottom: 5px; border-bottom-right-radius: 12px; border-bottom-left-radius: 0px;">
					<?php echo ucwords($box_title);?>
				</div>
</div>
