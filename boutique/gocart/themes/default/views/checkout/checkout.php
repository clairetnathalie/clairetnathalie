...
<div class="btn-group pull-right">
	...
	value="<?php echo lang('continue_shopping');?>" /></div>
</div>
</div>

<div class="row" style="margin-bottom: 10px;">
<div class="span12" id="customer_info_fields"
	style="border-bottom: 4px solid #ddd; padding-bottom: 15px;"><img
	alt="loading" src="<?php echo theme_img('ajax-loader.gif');?>" /></div>
</div>

<div id="shipping_payment_container" style="display: none;"><img
	alt="loading" src="<?php echo theme_img('ajax-loader.gif');?>" /></div>
