...
class ApiHelper {
	...
	public static function GetStatusCode($result) {
		...
		$_status [91] = "";
		$_status [92] = "";
		$_status [93] = "No information given by the sorting plan. If you want to do a collection or delivery at Point Relais, please check it is avalaible." . "If you want to do a home delivery, please check if the zipcode exists.";
